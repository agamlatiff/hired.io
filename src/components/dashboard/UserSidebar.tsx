    ...
    <aside className="w-64 border-r border-accent-dark flex flex-col h-full bg-[#161c14]">
      ...
      <nav className="flex-1 overflow-y-auto py-6 space-y-1">
        ...
        <div className="px-4 mt-8">
          <Link
            href="/find-jobs"
            className="flex items-center gap-3 px-4 py-3 bg-neon-green/10 border border-neon-green/30 rounded-xl text-neon-green hover:bg-neon-green/20 transition-all"
          >
      ...
      <div className="p-4 border-t border-accent-dark">
        <button
          ...
          className="w-full bg-card-dark p-3 rounded-xl flex items-center gap-3 border border-white/5 cursor-pointer hover:border-red-500/30 hover:bg-red-500/5 transition-colors"
        >
