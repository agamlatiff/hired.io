    ...
    <NextAuthProvider>
      <div className="bg-background-dark font-display text-white overflow-hidden h-screen flex">
        ...
        <main className="flex-1 overflow-y-auto bg-background-dark relative">
          ...
          <div className="relative z-10 p-6 md:p-10 max-w-[1920px] mx-auto">{children}</div>
          <footer className="mt-12 text-center text-xs text-gray-600 pb-6"><p>© 2024 hired.io Inc. Job Seeker Dashboard</p></footer>
        </main>
      </div>
    </NextAuthProvider>
  );
